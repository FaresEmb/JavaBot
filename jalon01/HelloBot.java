...
public class HelloBot extends Bot{
    ...
    String description() {
			return "["+super.name+"]"+" Salut "+super.userName+"! Nous sommes "+this.day_name.format(this.date)+" "+this.day.format(this.date)+" "+this.month.format(this.date)+" et il est "+this.hours.format(this.date)+"h"+this.minutes.format(this.date)+".";
		}
	}
